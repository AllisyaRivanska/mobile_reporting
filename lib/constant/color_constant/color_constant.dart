...
class ColorConstant {
  ...
  static const Color primaryColor = Color(0xFF288AEC);
  static const Color creamCard = Color(0xFFD9E9FF);
  static const Color lightBlue = Color(0xFFE6F3FA);  static const Color mediumYellow = Color(0xFFD6A13B);
